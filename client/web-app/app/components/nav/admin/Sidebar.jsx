...
export default function DefaultSidebar() {
  return (
    <Card className="h-screen fixed w-64 p-4 shadow-xl shadow-blue-gray-900/5 font-syne">
        ...
        <Menu placement="right-start font-syne">
          ...
          <MenuList className="bg-white p-3">
            <MenuItem className="p-2 border-b-2 text-lg flex">
              ...
              <Link href={`/admin/auction/create`}>Create New Auction</Link>
            </MenuItem>
            <MenuItem className="p-2 text-lg flex">
              <FaAngleRight className="my-auto mr-2" />
              <Link href={`/admin/auction/list`}>View All Auctions</Link>
            </MenuItem>
          </MenuList>
        </Menu>
