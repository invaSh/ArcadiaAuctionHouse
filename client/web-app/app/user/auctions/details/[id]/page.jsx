...
import AuctionItemCard from "@/app/components/items/AuctionItemCard";
import RegisterButton from "@/app/components/auctions/Button";
  ...
  return (
    <div>
      ...
      <div className="w-[75%] mx-auto flex gap-5 mt-12">
        <RegisterButton text={"register to bid"} />
        <AuctionButton />
      </div>
