...
export default async function Info({ params }) {
  ...
  return (
    <div className="mb-12">
      ...
      >
        <p className="text-3xl text-center text-white w-[50%]">
          {auction.shortDesc}
        </p>
      </div>
      {items > 0 && (
        <div className="w-full h-[75vh] flex ">
          ...
          >
            ...
            />
            <h1 className="text-2xl text-center pt-12 text-hover cursor-pointer">
              {randomItem.title}{" "}
              <u className="font-playfair">
                <i> "{randomItem.materials}"</i>
              </u>
            </h1>
            <p className="p-12">
